    ...
    $.validationEngineLanguage = {
        newLang: function(){
			...
			"func": function (field) {
                ...
                "validatePNameField": {
                    "alertText": "* Please enter a project name"
                },
                "validateEmailField": {
                    "alertText": "* Please enter your email"
                },
                "validateIncorrectPromoCode": {
                    "alertText": "* Incorrect promo code"
                },
                "validateIncorrectCache": {
                    "alertText": "* This field is incorrect"
                },
                "ccholder": {
                    "regex": /^[a-z0-9\ -\']+$/i,
                    "alertText": "* Invalid card holder name"
                },
				"irishMobile": {
					"regex": /08[356789]([ \-]?\d){7}/,
					"alertText": "* Not an Irish mobile number"
	            },
                "customPassword": {
                    "func": function (field) {
                    ...
                    "alertText": "* Invalid Password,   <br/>"
                        + "   1] Min 8 symbols.       <br/>"
                        + "   1] At least 1 uppercase letter.    <br/>"
                        + "   2] At least 1 lowercase letter.    <br/>"
